...
public class TestMetricDataServiceG39 {

    @Autowired
    IMetricDataService metricDataService;

    @Test
    public void testGetLevelDataLevel1G39() {
        System.out.println("------------------- G39 L1-------------------");
        ...
        Metric metric = Metric.LAST_MILE_RTO_PERCENTAGE;
    ...
    @Test
    public void testGetLevelDataLevel2G39() {
        System.out.println("------------------- G39 L2-------------------");
        SearchRequest request = new SearchRequest();
        request.setFilters(Collections.unmodifiableMap(new HashMap<String, List<String>>() {
            {
                put("durationtype", Arrays.asList("monthly"));
    ...
    @Test
    public void testGetLevelDataLevel3G39 (){
        System.out.println("------------------- G39 L3-------------------");
        SearchRequest request = new SearchRequest();
        request.setFilters(Collections.unmodifiableMap(new HashMap<String, List<String>>() {
            {
                put("durationtype", Arrays.asList("monthly"));
        ...
        request.setChartFilters(Collections.unmodifiableMap(new HashMap<String, Map<String, List<String>>>() {
            {
                ...
                put("THREE", Collections.unmodifiableMap(new HashMap<String, List<String>>() {
                    {
                        put("groupBy", Arrays.asList("currentstatus"));
                        put("cummulative", Arrays.asList("false"));
                    }
                }));
            }
        }));
    ...
    @Test
    public void testGetLevelDataLevel4G39() {
        System.out.println("------------------- G39 L4-------------------");
        SearchRequest request = new SearchRequest();
        request.setFilters(Collections.unmodifiableMap(new HashMap<String, List<String>>() {
            {
                put("durationtype", Arrays.asList("monthly"));
    ...
    @Test
    public void testGetLevelDataLevel5G39() {
        System.out.println("------------------- G39 L5-------------------");
        SearchRequest request = new SearchRequest();
        request.setFilters(Collections.unmodifiableMap(new HashMap<String, List<String>>() {
            {
                put("durationtype", Arrays.asList("monthly"));
