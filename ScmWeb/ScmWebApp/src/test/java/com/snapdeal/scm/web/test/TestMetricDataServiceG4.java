...
@WebIntegrationTest
public class TestMetricDataServiceG4 {

	@Autowired
	IMetricDataService metricDataService;
	
    @Test
    public void testGetLevelDataLevel1G4() {
        System.out.println("------------------- G4 L1-------------------");
        ...
        Metric metric = Metric.LAST_MILE_ATTEMPT_ADHERANCE;
    ...
    @Test
    public void testGetLevelDataLevel2M4() {
