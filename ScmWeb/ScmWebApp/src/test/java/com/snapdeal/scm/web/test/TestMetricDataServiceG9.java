...
@WebIntegrationTest
public class TestMetricDataServiceG9 {
	   @Autowired
	    IMetricDataService metricDataService;

	    @Test
	    public void testGetLevelDataLevel1G9() {
	        System.out.println("------------------- G9 L1-------------------");
	        ...
	        Metric metric = Metric.PENDENCY_NON_INTEGRATED_COURIERS;
	    ...
	    @Test
	    public void testGetLevelDataLevel2G9() {
	        System.out.println("------------------- G9 L2-------------------");
	        SearchRequest request = new SearchRequest();
	        request.setFilters(Collections.unmodifiableMap(new HashMap<String, List<String>>() {
	            {
	                put("durationtype", Arrays.asList("daily"));
	    ...
	    @Test
	    public void testGetLevelDataLevel3G9() {
	        System.out.println("------------------- G9 L3-------------------");
	        SearchRequest request = new SearchRequest();
	        request.setFilters(Collections.unmodifiableMap(new HashMap<String, List<String>>() {
	            {
	                put("durationtype", Arrays.asList("daily"));
	    ...
	    @Test
	    public void testGetLevelDataLevel4G9() {
	        System.out.println("------------------- G9 L4-------------------");
	        SearchRequest request = new SearchRequest();
	        request.setFilters(Collections.unmodifiableMap(new HashMap<String, List<String>>() {
	            {
	                put("durationtype", Arrays.asList("daily"));
	        ...
	        request.setOptions(Collections.unmodifiableMap(new HashMap<String, String>() {
	            {
	                ...
	                put("couriergroup", "FEDEX");	                
	                put("origincity", "Delhi");
	                put("destinationstate", "maharashtra");
	                put("lane", "lane1");
