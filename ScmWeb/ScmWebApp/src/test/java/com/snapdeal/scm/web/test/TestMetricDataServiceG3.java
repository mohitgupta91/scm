...
public class TestMetricDataServiceG3 {

    @Autowired
    IMetricDataService metricDataService;

    @Test
    public void testGetLevelDataLevel1G3() {
        System.out.println("------------------- G3 L1-------------------");
        ...
        Metric metric = Metric.LAST_MILE_DELIVERY_ADHERANCE;
    ...
    @Test
    public void testGetLevelDataLevel2M3() {
    ...
    @Test
    public void testGetLevelDataLevel3M3() {
    ...
    @Test
    public void testGetLevelDataLevel4M3() {
        System.out.println("------------------- G3 L4-------------------");
        SearchRequest request = new SearchRequest();
        request.setFilters(Collections.unmodifiableMap(new HashMap<String, List<String>>() {
            {
                put("durationtype", Arrays.asList("daily"));
