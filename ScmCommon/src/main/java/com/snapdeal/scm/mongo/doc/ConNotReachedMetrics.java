 ...
 * @author chitransh
 */
@Document(collection = "con_not_reached_metrics")
public class ConNotReachedMetrics extends MongoDocument {
    ...
    public ConNotReachedMetrics() {
    }

    public ConNotReachedMetrics(Map<SubOrderDetailElasticColumn, String> fieldsMap) {
