 ...
 * @author chitransh
 */
@Document(collection = "attempt_not_del_non_integrated_metrics")
public class AttemptNotDelNonIntgrMetrics {
    ...
    public AttemptNotDelNonIntgrMetrics() {
    }

    public AttemptNotDelNonIntgrMetrics(Map<SubOrderDetailElasticColumn, String> fieldsMap) {
