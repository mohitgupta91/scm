 ...
 * @author chitransh
 */
@Document(collection = "reached_not_ofd_metrics")
public class ReachedNotOFDMetrics extends MongoDocument {
    ...
    public ReachedNotOFDMetrics() {
    }

    public ReachedNotOFDMetrics(Map<SubOrderDetailElasticColumn, String> fieldsMap) {
