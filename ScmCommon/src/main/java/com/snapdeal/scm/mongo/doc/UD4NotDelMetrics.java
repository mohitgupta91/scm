 ...
 * @author chitransh
 */
@Document(collection = "ud4_not_del_metrics")
public class UD4NotDelMetrics extends MongoDocument {

    private String   courierGroup;
    private String   courierType;
    private String   destinationState;
    private String   destinationCity;
    private String   ud4Bucket;
    private TimeUnit timeUnit;
    private Long     limit1;
    private Long     limit2;

    public UD4NotDelMetrics() {
    }

    public UD4NotDelMetrics(Map<SubOrderDetailElasticColumn, String> fieldsMap) {
        fieldsMap.keySet().forEach(field -> {
            switch (field) {
                ...
                case COURIER_ORIGIN_CITY:
                    ...
                    break;
                // todo: add mapping for UD4 bucket
            }
        });
    }
    ...
    public String getUd4Bucket() {
        return ud4Bucket;
    }

    public void setUd4Bucket(String ud4Bucket) {
        this.ud4Bucket = ud4Bucket;
    }
