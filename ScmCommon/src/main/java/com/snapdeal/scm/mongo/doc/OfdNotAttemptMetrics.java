 ...
 * @author chitransh
 */
@Document(collection = "ofd_not_attempt_metrics")
public class OfdNotAttemptMetrics extends MongoDocument {
    ...
    public OfdNotAttemptMetrics() {
    }

    public OfdNotAttemptMetrics(Map<SubOrderDetailElasticColumn, String> fieldsMap) {
